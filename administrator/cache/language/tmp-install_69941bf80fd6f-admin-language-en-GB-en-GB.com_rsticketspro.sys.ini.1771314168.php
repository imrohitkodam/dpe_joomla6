...
return array (
  ...
  'RSTICKETSPRO' => 'RSTickets! Pro',
  'COM_RSTICKETSPRO' => 'RSTickets! Pro',
  'COM_RSTICKETSPRO_OVERVIEW' => 'Overview',
  'COM_RSTICKETSPRO_MANAGE_TICKETS' => 'Manage Tickets',
  'COM_RSTICKETSPRO_DEPARTMENTS' => 'Departments',
  'COM_RSTICKETSPRO_CUSTOM_FIELDS' => 'Department - Custom Fields',
  'COM_RSTICKETSPRO_GROUPS' => 'Staff Groups',
  'COM_RSTICKETSPRO_STAFF_MEMBERS' => 'Staff Members',
  'COM_RSTICKETSPRO_PRIORITIES' => 'Priorities',
  'COM_RSTICKETSPRO_STATUSES' => 'Statuses',
  'COM_RSTICKETSPRO_KNOWLEDGEBASE' => 'Knowledgebase',
  'COM_RSTICKETSPRO_EMAIL_MESSAGES' => 'Email Messages',
  'COM_RSTICKETSPRO_CONFIGURATION' => 'Configuration',
  'COM_RSTICKETSPRO_BACK_TO_RSTICKETSPRO' => 'Back to RSTickets! Pro',
  'COM_RSTICKETSPRO_KB_ARTICLES' => 'Articles',
  'COM_RSTICKETSPRO_KB_ARTICLES_DESC' => 'Here you can write articles for the Knowledgebase.',
  'COM_RSTICKETSPRO_KB_CATEGORIES' => 'Categories',
  'COM_RSTICKETSPRO_KB_CATEGORIES_DESC' => 'Categories are used for storing articles. You will need at least one category for your articles.',
  'COM_RSTICKETSPRO_KB_CONVERSION_RULES' => 'Article Conversion Rules',
  'COM_RSTICKETSPRO_KB_CONVERSION_RULES_DESC' => 'You can setup rules for converting tickets to Knowledgebase articles.',
  'COM_RSTICKETSPRO_KB_TEMPLATE' => 'Article Template',
  ...
  'RST_TICKETS_DEFAULT_LAYOUT' => 'Tickets - List',
  ...
  'RST_SEARCH_DEFAULT_LAYOUT' => 'Tickets - Search',
  'RST_SUBMIT_TICKETS' => 'Submit Tickets',
  'RST_SUBMIT_TICKETS_MENU_DESC' => 'Show the submit tickets form',
  'RST_SUBMIT_TICKETS_LAYOUT' => 'Tickets - Submit Form',
  'RST_SHOW_SUBMIT_FORM_HEADINGS' => 'Show Submit Form Headings',
  'RST_SHOW_SUBMIT_FORM_HEADINGS_DESC' => 'By enabling this, the submit ticket form will have headings for each section.',
  'RST_SIGNATURE' => 'Signature',
  'RST_SIGNATURE_MENU_DESC' => 'Allow to the user to change his signature',
  'RST_SIGNATURE_DEFAULT_LAYOUT' => 'Misc - Change Signature',
  'RST_KB_DEFAULT_LAYOUT' => 'Knowledgebase - List',
  ...
  'RST_KB_ARTICLE_MENU_DESC' => 'Shows an article from your Knowledgebase.',
  'RST_KB_ARTICLE_DEFAULT_LAYOUT' => 'Knowledgebase - Article',
  'RST_MANAGE_SEARCHES' => 'Manage Searches',
  'RST_MANAGE_SEARCHES_MENU_DESC' => 'Shows the staff member\'s predefined searches.',
  'RST_SEARCHES_DEFAULT_LAYOUT' => 'Misc - Predefined Searches',
  'RST_DASHBOARD' => 'Dashboard',
  'RST_DASHBOARD_DEFAULT_LAYOUT' => 'Tickets - Dashboard',
  ...
  'RST_REMOVE_DATA_DEFAULT_LAYOUT' => 'User - Remove Data',
  'RST_REMOVE_DATA_MENU_DESC' => 'This layout allows the user to initiate a data removal request.',
  ...
  'COM_RSTICKETSPRO_DEFAULT_MESSAGE' => 'Default Message',
  'COM_RSTICKETSPRO_DEFAULT_MESSAGE_DESC' => 'This is the default message you want to display in the \'Message\' box.',
);

...
return array (
  ...
  'COM_CLUSTER_N_ITEMS_CHECKED_IN_0' => 'No item successfully checked in',
  'COM_CLUSTER_N_ITEMS_CHECKED_IN_1' => '%d item successfully checked in',
  'COM_CLUSTER_N_ITEMS_CHECKED_IN_MORE' => '%d items successfully checked in',
  'COM_CLUSTER_N_ITEMS_DELETED' => '%d items successfully deleted',
  'COM_CLUSTER_N_ITEMS_DELETED_1' => '%d item successfully deleted',
  'COM_CLUSTER_N_ITEMS_PUBLISHED' => '%d items successfully published',
  'COM_CLUSTER_N_ITEMS_PUBLISHED_1' => '%d item successfully published',
  'COM_CLUSTER_N_ITEMS_TRASHED' => '%d items successfully trashed',
  'COM_CLUSTER_N_ITEMS_TRASHED_1' => '%d item successfully trashed',
  'COM_CLUSTER_N_ITEMS_UNPUBLISHED' => '%d items successfully unpublished',
  ...
  'COM_CLUSTER_TEST_LABEL' => 'Test label',
  'COM_CLUSTER_FIELDSET_RULES' => 'Permissions',
  'COM_CLUSTER_FROM_FILTER' => 'From %s',
  'COM_CLUSTER_TO_FILTER' => 'To %s',
  'COM_CLUSTER_VIEW_FILE' => '[View File]',
  'COM_CLUSTER_ITEMS_SUCCESS_DUPLICATED' => 'Items successfully duplicated',
  'COM_CLUSTER_EMPTY_DATA' => 'Empty Data',
  'COM_CLUSTER_BINDING_ERROR' => 'Error while binding Data',
  'COM_CLUSTERS_VIEW_CLUSTERS' => 'Clusters',
  ...
  'COM_CLUSTER_PAGE_EDIT_CLUSTER' => 'Clusters: Edit',
  'COM_CLUSTER_PAGE_VIEW_CLUSTER' => 'Clusters: View',
  'COM_CLUSTER_TITLE_ITEM_VIEW_CLUSTER_DESC' => 'Show a specific Cluster',
  'COM_CLUSTER_TITLE_CLUSTER' => 'Cluster',
  'COM_CLUSTER_LIST_CLUSTERS_NAME' => 'Name',
  'COM_CLUSTER_LIST_CLUSTERS_CLIENT' => 'Client',
  ...
  'COM_CLUSTER_USER_FORM_LBL_CLUSTER_HEADER' => 'Select Cluster',
  'COM_CLUSTER_USER_FORM_LBL_CLUSTER' => 'Cluster',
  'COM_CLUSTER_USER_FORM_LBL_CLUSTER_DESC' => 'Select Cluster',
  'COM_CLUSTER_USER_FORM_LBL_USER' => 'Cluster User',
  'COM_CLUSTER_USER_FORM_LBL_USER_DESC' => 'Select User',
  'COM_CLUSTERS_VIEW_CLUSTER_USERS' => 'Cluster users',
  'COM_CLUSTER_PAGE_VIEW_CLUSTER_USER' => 'Cluster User: View',
  'COM_CLUSTER_PAGE_ADD_USER' => 'Cluster user: New',
  'COM_CLUSTER_PAGE_EDIT_USER' => 'Cluster user: Edit',
  'COM_CLUSTER_PAGE_VIEW_USER' => 'Cluster user: View',

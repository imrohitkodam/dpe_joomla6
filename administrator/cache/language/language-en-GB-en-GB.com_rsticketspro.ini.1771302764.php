...
return array (
  ...
  'COM_RSTICKETSPRO_N_ITEMS_DELETED' => 'Item successfully deleted.',
  ...
  'RST_NO_KB_SUBCATEGORIES' => 'Unfortunately this category does not have any subcategories to be displayed.',
  ...
  'RST_REPLY' => 'Reply',
  'RST_DB_SUBMIT' => 'Submit',
  'RST_DB_SEARCH' => 'Search',
  'RST_DB_VIEW' => 'View',
  'RST_YOUR_INFORMATION_HEADING' => 'Your Information',
  'RST_TECHNICAL_INFORMATION_HEADING' => 'Technical Information',
  'RST_ISSUE_DETAILS_HEADING' => 'Issue Details',
  'RST_FILE_ATTACHMENTS_HEADING' => 'File Attachments',
  'RST_SPAM_PROTECTION_HEADING' => 'Spam Protection',
  'RST_PRIVACY_AGREEMENT_HEADING' => 'Privacy Agreement',
  ...
  'RST_TICKET_REPLIES_NUM' => '%d replies',
  ...
  'RST_TICKET_LAST_REPLY_MESSAGE' => 'Last Reply Message',
  ...
  'RST_REPLY_TO_TICKET' => 'Add a new message',
  'RST_CONVERSATION' => 'Conversation',
  ...
  'RST_YOUR_SIGNATURE_DESC' => 'This is the signature that will be appended with every message.',
  ...
  'RST_TICKET_REPLIES_CLOSED_ERROR' => 'Unfortunately, you cannot add new replies to this ticket - this ticket has been marked as closed.',
  ...
  'RST_TICKET_REPLY_AS_CUSTOMER' => 'Reply as Customer',
  'RST_TICKET_SUBMITTED_BY' => '<small>Submitted by: %s</small>',
  'RST_DO_NOT_CHANGE_DEPARTMENT' => 'Do not change department',
  'RST_DO_NOT_CHANGE_ASSIGNMENT' => 'Do not change assignment',
  'RST_DO_NOT_CHANGE_PRIORITY' => 'Do not change priority',
  'RST_DO_NOT_CHANGE_STATUS' => 'Do not change status',
  'RST_DO_NOT_NOTIFY' => 'Do not notify',
  'RST_DO_NOT_DELETE' => 'Do not delete',
  ...
  'COM_RSTICKETSPRO_FROM_DATE' => 'From Date',
  'COM_RSTICKETSPRO_TO_DATE' => 'To Date',
  ...
  'RST_DELETE' => 'Delete',
  'RST_YOUR_EMAIL' => 'Your Email <span class=\'star\'>*</span>',
  'RST_YOUR_EMAIL_DESC' => 'We need your email address.',
  'RST_YOUR_PASSWORD' => 'Your Password <span class=\'star\'>*</span>',
  'RST_YOUR_PASSWORD_DESC' => 'Set the password for your new account.',
  'RST_YOUR_NAME' => 'Your Name <span class=\'star\'>*</span>',
  ...
  'RST_TICKET_ATTACHMENTS_REQUIRED' => 'Attachment(s) *',
  'RST_TICKET_ATTACHMENTS_DESC' => 'You can attach files to your message.',
  'RST_TICKET_ATTACHMENTS_ALLOWED' => 'Allowed attachments are: <strong>%s</strong>.',
  'RST_TICKET_ATTACHMENTS_MAX_ALLOWED' => 'You can upload a maximum of <strong>%s</strong> files.',
  'RST_UNLIMITED' => 'unlimited',
  'RST_TICKET_ATTACHMENTS_MAX_SIZE_ALLOWED' => 'Maximum file size is <strong>%s</strong>.',
  ...
  'RST_ANTISPAM' => 'Antispam',
  'RST_SUBMIT' => 'Submit',
  'RST_TICKET_FILE_DOWNLOADS' => 'downloaded %d times.',
  'RST_TICKET_FILE_DOWNLOADS_SMALL' => '%s (%d downloads)',
  'RST_MAX_UPLOAD_FILES_REACHED' => 'The maximum number of attachments has been reached. You cannot add any more attachments.',
  'RST_TICKET_CONSENT_SUBMIT' => 'I consent to this website collecting my details through this form. *',
  'COM_RSTICKETSPRO_CONSENT_IS_NEEDED_TO_SUBMIT_THIS_FORM' => 'Your consent is required to submit this form; please tick the checkbox located above the Submit button.',
  'COM_RSTICKETSPRO_BLOCKLISTED_EMAIL_ERROR' => 'The email address \'%s\' has been blocked. You cannot submit tickets using this address.',
  ...
  'RST_TICKET_EMAIL_CUSTOMER_ERROR' => 'This email address (%s) already exists. You will have to login in order to submit a ticket.',
  'RST_TICKET_EMPTY_PASSWORD' => 'Empty passwords are not allowed.',
  'RST_TICKET_EMAIL_STAFF_NO_PERMISSION_ERROR' => 'You cannot submit a ticket using your own email address.',
  'RST_TICKET_NAME_ERROR' => 'Please write your full name.',
  'RST_TICKET_CUSTOMER_ERROR' => 'Please select a customer from the list.',
  'RST_TICKET_STAFF_CANNOT_ADD_TICKET_TO_CUSTOMER_ERROR' => 'You are not allowed to submit a ticket on behalf of a customer.',
  ...
  'RST_TICKET_REPLY_ERROR' => 'Please write a message reply for your ticket.',
  ...
  'RST_CAPTCHA_MISSING_SITE_KEY' => 'You are missing your Site Key. Did you setup the correct Site Key in the Configuration?',
  'RST_CAPTCHA_MISSING_SECRET_KEY' => 'The secret parameter is missing. Did you setup the correct Secret Key in the Configuration?',
  'RST_CAPTCHA_NEW_ERR_MISSING_INPUT_SECRET' => '(reCAPTCHA) The secret parameter is missing. Did you setup the correct Secret Key in the Configuration?',
  'RST_CAPTCHA_NEW_ERR_INVALID_INPUT_SECRET' => '(reCAPTCHA) The secret parameter is invalid or malformed. Please double check the Secret Key in your Configuration.',
  'RST_CAPTCHA_BUILT_IN_NOT_SELECTED' => 'Built-in Captcha is not selected.',
  'RST_CAPTCHA_NEW_ERR_MISSING_INPUT_RESPONSE' => '(reCAPTCHA) The response is missing. Did you tick the \'I am not a robot\' checkbox?',
  'RST_CAPTCHA_NEW_ERR_INVALID_INPUT_RESPONSE' => '(reCAPTCHA) The response is invalid or malformed. Did you tick the \'I am not a robot\' checkbox?',
  'COM_RSTICKETSPRO_UPLOAD_TICKET_REQUIRED_ERROR' => 'Please upload your attachments in order to submit this ticket.',
  ...
  'RST_STAFF_CANNOT_DELETE_NOTES' => 'Unfortunately, you do not have the permission to delete this note.',
  ...
  'RST_CANNOT_DELETE_TICKET_MESSAGE_NOT_EXISTS' => 'The message you requested to be deleted does not exist.',
  'RST_CANNOT_UPDATE_TICKET_MESSAGE' => 'Unfortunately, you do not have the permission to update this message.',
  ...
  'RST_CANNOT_UPDATE_TIME_SPENT' => 'Unfortunately, you do not have the permission to update the time spent on this ticket.',
  ...
  'RST_CANNOT_DOWNLOAD_FROM_EMAIL' => 'Unfortunately, the tokens do not match. Please login and try again.',
  'RST_COULD_NOT_CHANGE_STAFF_MEMBER_DOES_NOT_BELONG_TO_TICKET_DEPARTMENT' => 'Could not change staff member of ticket %s because assigned staff member does not have access to this ticket\'s department.',
  'RST_STAFF_CANNOT_EXPORT_TICKETS' => 'Unfortunately, you are not allowed to export tickets.',
  'RST_TICKET_SUBMIT_REPLY_OK' => 'Your ticket reply has been successfully added.',
  'RST_DELETE_TICKET_MESSAGE_OK' => 'The ticket reply has been successfully removed.',
  'RST_DELETE_TICKET_MESSAGE_CONFIRM' => 'Are you sure you want to delete this reply?',
  'RST_DELETE_TICKET_ATTACHMENT_CONFIRM' => 'Are you sure you want to delete the attachment \'%s\'?',
  'RST_UPDATE_TICKET_MESSAGE_OK' => 'The ticket reply has been successfully updated.',
  ...
  'RST_TICKET_NOT_DELETED' => 'You do not have the permission to delete ticket with ID %d.',
  'RST_BACK' => 'Back',
  'RST_YES' => 'Yes',
  'RST_NO' => 'No',
  ...
  'RST_NONE_SUPPLIED' => 'None supplied',
  'RST_SEARCH_NAME_ERROR' => 'Please supply a name for the search.',
  'RST_FILTER' => 'Filter',
  'RST_FILTER_ALL' => 'All articles',
  ...
  'RST_HOT' => '(Hot!)',
  'RST_CLEAR' => 'Clear',
  'RST_JQUERY_NOT_FOUND' => 'The Magnific Popup script does not work without the jQuery library.',
  'RST_KB_ARTICLE_DRAFT' => 'Draft',
  'RST_KB_ARTICLE_DRAFT_BACK' => 'Back to current version',
  'RST_KB_ARTICLE_VIEW_DRAFT' => 'View draft',
  'RST_KB_ARTICLE_NO_DRAFT' => 'This article does not have a draft yet.',
  'RST_KB_ARTICLE_FEEDBACK_HELPFUL_MAIN_TITLE' => 'Was this article helpful?',
  'RST_KB_ARTICLE_FEEDBACK_HELPED_USERS' => '<strong>%s persons</strong> found this article helpful.',
  'RST_KB_ARTICLE_FEEDBACK_HELPED_USERS_1' => '<strong>One person</strong> found this article helpful.',
  'RST_KB_ARTICLE_FEEDBACK_MESSAGE_SUCCESS' => 'Thanks for your feedback.',
  'RST_KB_ARTICLE_FEEDBACK_MESSAGE_ERROR' => 'Something went wrong please refresh this page and try again.',
  'RST_KB_ARTICLE_FEEDBACK_MESSAGE_ALREADY_POSTED_ERROR' => 'You have already posted a feedback on this article.',
  'RST_HISTORY_DATE' => 'Date',
  'RST_HISTORY_IP' => 'IP',
  'RST_HISTORY_VIEWED' => 'User',
  'RST_HISTORY_ACTION' => 'Action',
  'RST_HISTORY_ACTION_VIEW' => 'Viewed',
  'RST_HISTORY_ACTION_CLOSE' => 'Closed',
  'RST_HISTORY_ACTION_AUTOCLOSE' => 'Auto-Closed',
  'RST_HISTORY_ACTION_REOPEN' => 'Reopened',
  'RST_HISTORY_ACTION_NOTIFY' => 'Notified (Auto-close)',
  'RST_HISTORY_ACTION_ONHOLD' => 'On hold',
  'RST_NOTES_USER' => 'User',
  'RST_TICKET_NOTE' => 'Note',
  'RST_TICKET_NOTE_DESC' => 'This is the text of the note.',
  'RST_TICKET_ADD_NOTE' => 'New note',
  'RST_ADD_NOTE' => 'Add Note',
  'RST_EDIT_NOTE' => 'Edit Note',
  ...
  'RST_EDIT_TICKET_MESSAGE' => 'Edit Ticket Message',
  ...
  'RST_ALTERNATIVE_EMAIL_DESC' => 'Provide an alternative email addres that you can use to reply from the email to tickets',
  ...
  'RST_SEF_REMOVE_DATA' => 'remove-data',
  'RST_SEF_REMOVE_DATA_SUCCESS' => 'remove-data-success',
  'RST_SEF_REMOVE_DATA_PROCESS' => 'remove-data-process',
  'RST_SEF_DELETE_ATTACHMENT' => 'delete-attachment',
  'RST_SYSMESSAGE_MISSING' => '<i>missing</i>',
  'RST_SYSMESSAGE_TICKET_DEPARTMENT_CHANGE' => 'Department has been changed from <strong>%1$s</strong> to <strong>%2$s</strong> by <strong>%3$s</strong>.',
  'RST_SYSMESSAGE_TICKET_PRIORITY_CHANGE' => 'Priority has been changed from <strong>%1$s</strong> to <strong>%2$s</strong> by <strong>%3$s</strong>.',
  'RST_SYSMESSAGE_TICKET_STATUS_CHANGE' => 'Status has been changed from <strong>%1$s</strong> to <strong>%2$s</strong> by <strong>%3$s</strong>.',
  'RST_SYSMESSAGE_TICKET_STAFF_CHANGE' => 'Staff member has been changed from <strong>%1$s</strong> to <strong>%2$s</strong> by <strong>%3$s</strong>.',
  'RST_SYSMESSAGE_TICKET_AUTO_CLOSE' => 'This ticket has been auto-closed because no reply has been received from the customer in <strong>%d</strong> days.',
  'COM_RSTICKETSPRO_REMOVE_DATA_AND_CLOSE_ACCOUNT' => 'Remove my data and close my account.',
  'COM_RSTICKETSPRO_REMOVE_DATA_AND_CLOSE_ACCOUNT_SURE' => 'This action is irreversible. This will remove all data from your tickets and anonymise your account\'s data.',
  'COM_RSTICKETSPRO_REMOVE_DATA_AND_CLOSE_ACCOUNT_SURE_NO_LOGIN' => 'This action is irreversible. This will remove all data from your tickets and anonymise your account\'s data, including sensitive information such as username and password. As a result, you will no longer be able to login.',
  'COM_RSTICKETSPRO_REMOVE_DATA_AND_CLOSE_ACCOUNT_SURE_CONT' => 'Are you sure you want to do this? By clicking on Yes an encrypted URL will be sent to your email address for verification which will allow you to remove all of your data.',
  'COM_RSTICKETSPRO_YES_SEND_ME_A_LINK' => 'Yes, send me a link to %s.',
  'COM_RSTICKETSPRO_MUST_BE_LOGGED_IN' => 'You must be logged in to access this feature.',
  'COM_RSTICKETSPRO_THIS_FEATURE_MUST_BE_ENABLED' => 'This feature must be enabled first.',
  'COM_RSTICKETSPRO_THIS_FEATURE_IS_NOT_AVAILABLE_FOR_SUPER_USERS' => 'This feature is not available for Super Users.',
  'COM_RSTICKETSPRO_LINK_HAS_BEEN_SENT' => 'The link has been sent to the specified email address.',
  'COM_RSTICKETSPRO_REMOVE_REQUEST_EMAIL_SUBJECT' => 'Data removal request for %s at %s',
  'COM_RSTICKETSPRO_REMOVE_REQUEST_EMAIL_BODY' => 'Hello %s,<br /><br />You may now use the following link to remove all of your data from our website: %s<br />Please note that this action cannot be undone and you will no longer be able to login or access your tickets on our website.',
  'COM_RSTICKETSPRO_TOKEN_IS_INCORRECT' => 'The token you have supplied is incorrect. Please make sure the link you have followed is the correct one.',

...
return array (
  ...
  'COM_RSTICKETSPRO_CSV_EXPORT_SETTINGS' => 'CSV Export Settings',
  'COM_RSTICKETSPRO_CSV_STRIP_TAGS' => 'Strip HTML Tags',
  'COM_RSTICKETSPRO_CSV_STRIP_TAGS_DESC' => 'Set this to Yes if you would like to strip HTML tags from the exported messages.',
  'COM_RSTICKETSPRO_CSV_STRIP_NEWLINES' => 'Strip New Lines',
  'COM_RSTICKETSPRO_CSV_STRIP_NEWLINES_DESC' => 'Set this to Yes if you would like to strip newlines from the exported messages.',
  'COM_RSTICKETSPRO_CSV_DELIMITER' => 'Delimiter',
  'COM_RSTICKETSPRO_CSV_ENCLOSURE' => 'Enclosure',
  ...
  'RST_KB_SHOW_CATEGORY_NAME' => 'Show Category Name',
  'RST_KB_SHOW_CATEGORY_NAME_DESC' => 'Enable to show the category name in frontend.',
  ...
  'RST_KB_CATEGORY_THUMB' => 'Thumb',
  'RST_KB_CATEGORY_THUMB_DESC' => 'This is the thumb image displayed next to the category name.',
  ...
  'RST_CATEGORY_RESULTS_LAYOUT' => 'Results Layout',
  'RST_CATEGORY_RESULTS_LAYOUT_DESC' => 'Select the way you would like the articles to be displayed.',
  'RST_LIST_LAYOUT' => 'List Layout',
  'RST_COLUMN_LAYOUT' => 'Column Layout',
  'RST_CATEGORY_COLUMNS_NUMBER' => 'Columns Number',
  'RST_CATEGORY_COLUMNS_NUMBER_DESC' => 'Select how many columns should the layout have.',
  'RST_CATEGORY_TAG_SORTING' => 'Results Tag Sorting',
  'RST_CATEGORY_TAG_SORTING_DESC' => 'Enable to display a list of tags corresponding to the articles of this category.',
  ...
  'RST_IMAGE_UPLOAD_ERROR' => 'Could not upload the image!',
  'RST_IMAGE_UPLOAD_ERROR_FOLDER' => 'Could not upload the image to %s!',
  'RST_IMAGE_UPLOAD_EXTENSION_ERROR' => 'Could not upload image! The extension is not in the allowed list: %s.',
  ...
  'RST_KB_ARTICLE_DRAFT_DESC' => 'This is a draft of the article. Article drafts can only be seen by staff members.',
  'RST_KB_ARTICLE_THUMB' => 'Thumb',
  'RST_KB_ARTICLE_THUMB_DESC' => 'This is the article thumb image displayed in next to the article title in knowledgebase listing.',
  'RST_KB_ARTICLE_TAGS' => 'Tags',
  'RST_KB_ARTICLE_TAGS_DESC' => 'Insert the tags you wish the article to be found by.',
  ...
  'COM_RSTICKETSPRO_TICKET_SUBMISSION' => 'Ticket Submission',
  'COM_RSTICKETSPRO_STAFF_OPTIONS' => 'Staff Options',
  ...
  'COM_RSTICKETSPRO_FORMS_CONSENT_STAFF_SKIP' => 'Skip Consent for Staff Members',
  'COM_RSTICKETSPRO_FORMS_CONSENT_STAFF_SKIP_DESC' => 'The consent checkbox will not appear for staff members, just customers.',
  ...
  'RST_GLOBAL_MESSAGE_POSITION' => 'Global Message Position',
  'RST_GLOBAL_MESSAGE_POSITION_DESC' => 'Choose where you would like the global message to be displayed.',
  ...
  'RST_SUBMIT_MESSAGE_POSITION' => 'Submit Message Position',
  'RST_SUBMIT_MESSAGE_POSITION_DESC' => 'Choose where you would like the submit message to be displayed.',
  'RST_MESSAGE_FORM_TOP' => 'At the Top of the Form',
  'RST_MESSAGE_FORM_BOTTOM' => 'At the Bottom of the Form',
  'RST_MESSAGE_FORM_DISABLED' => 'Disabled',
  ...
  'RST_USE_PREDEFINED_SUBJECTS_DESC' => 'If you would like to use predefined subjects instead of having your customers input their subject in a textbox, set this to Yes. These can be configured by editing each department.',
  'RST_AVATARS' => 'Avatars',
  ...
  'RST_EMAIL_REPLY_TO' => 'Reply To Email',
  'RST_EMAIL_REPLY_TO_DESC' => 'This is the email address of the \'Reply-To\' header.',
  'RST_EMAIL_REPLY_TO_NAME' => 'Reply To Name',
  'RST_EMAIL_REPLY_TO_NAME_DESC' => 'This is the name associated with the email address of the \'Reply-To\' header.',
  ...
  'RST_EMAIL_USE_GLOBAL_DESC' => 'You can setup so that RSTickets! Pro uses the Joomla! Global Configuration settings in order to prefill the \'From Name\', \'From Email Address\', \'Reply To Email\' and \'Reply To Name\' when sending emails.',
  ...
  'RST_AUTOCLOSE' => 'Auto-close',
  'RST_AUTOCLOSE_ENABLE' => 'Enable Auto-close',
  'RST_AUTOCLOSE_ENABLE_DESC' => 'Enable the auto-closing of tickets when they exceed a pre-set number of days with no replies.',
  'RST_AUTOCLOSE_AUTOMATICALLY_LABEL' => 'Enable Auto-notify',
  'RST_AUTOCLOSE_AUTOMATICALLY_DESC' => 'Tickets will be notified automatically if they exceed the pre-set number of days',
  'RST_AUTOCLOSE_CHECK' => 'Check for Tickets Marked for Auto-closing Every (minutes)',
  'RST_AUTOCLOSE_CHECK_DESC' => 'Checks for tickets marked for auto-closing every specified number of minutes.',
  ...
  'RST_AUTOCLOSE_DAYS_STATUS' => 'Days a Ticket Should Go into Auto-close Status',
  'RST_AUTOCLOSE_DAYS_STATUS_DESC' => 'The number of days a ticket should go into auto-close status',
  'RST_AUTOCLOSE_DAYS_STATUS_ERROR' => 'You need at least 1 day before the ticket goes into autoclose status.',
  'RST_AUTOCLOSE_DAYS_CLOSED' => 'Days a Ticket Should Be Auto-closed (after notification is sent)',
  'RST_AUTOCLOSE_DAYS_CLOSED_DESC' => 'The number of days after a ticket should be auto-closed (after notification is sent)',
  'RST_AUTOCLOSE_DAYS_CLOSED_ERROR' => 'You need at least 1 day before the ticket gets automatically closed.',
  'RST_FOLLOWUP_CHECK' => 'Check for Tickets Marked as Closed Every (minutes)',
  'RST_FOLLOWUP_CHECK_DESC' => 'Checks every specified minutes if there are any closed tickets that a follow-up email can be sent to. Set this to at least 10 minutes apart to ensure the server won\'t overload.',
  ...
  'RST_DASHBOARD_THUMBS_TYPE' => 'Thumbs Type',
  'RST_DASHBOARD_THUMBS_TYPE_DESC' => 'Choose which way you would like the sections thumbs to be displayed.',
  'RST_DASHBOARD_ICONS' => 'Icons',
  'RST_DASHBOARD_IMAGES' => 'Images',
  'RST_DASHBOARD_SUBMIT_TICKET_IMAGE' => 'Submit Ticket Image',
  'RST_DASHBOARD_SUBMIT_TICKET_IMAGE_DESC' => 'Choose the image you would like to be displayed as thumb for Submit Ticket section.',
  'RST_DASHBOARD_VIEW_TICKETS_IMAGE' => 'View Tickets Image',
  'RST_DASHBOARD_VIEW_TICKETS_IMAGE_DESC' => 'Choose the image you would like to be displayed as thumb for View Tickets section.',
  'RST_DASHBOARD_SEARCH_TICKETS_IMAGE' => 'Search Ticket Image',
  'RST_DASHBOARD_SEARCH_TICKETS_IMAGE_DESC' => 'Choose the image you would like to be displayed as thumb for Search Ticket section.',
  'RST_KB_ADVANCED_SEF' => 'Advanced SEF',
  'RST_KB_ADVANCED_SEF_DESC' => 'Enable URL SEF optimization based on categories hierarchy.',
  'RST_KB_AUTO_CALCULATE_HOT_HITS' => 'Auto-calculate Hot Articles Threshold',
  'RST_KB_AUTO_CALCULATE_HOT_HITS_DESC' => 'Once per day the \'Hot\' article threshold will be auto-calculated to 75% of the most viewed article.',
  ...
  'RST_KB_FEEDBACK_SECTION' => 'Feedback Section',
  'RST_KB_FEEDBACK_SECTION_DESC' => 'Enable to display a feedback section on each knowledgebase article.',
  'RST_KB_SHOW_THUMBS' => 'Show Thumbs',
  'RST_KB_SHOW_THUMBS_DESC' => 'Enable to display the category thumb next to the title in details view.',
  ...
  'RST_DASHBOARD_SHOW_SEARCH' => 'Show Search',
  'RST_DASHBOARD_SHOW_SEARCH_DESC' => 'If enabled, a search field will be displayed in the tickets dashboard.',
  ...
  'RST_SHOW_KB_SUBCATEGORIES_LIST' => 'Show Knowledgebase Subcategories',
  'RST_SHOW_KB_SUBCATEGORIES_LIST_DESC' => 'Choose the maximum number of subcategories to display for each knowledgebase category.',
  'RST_DASHBOARD_SPLIT_KB_TO_TABS' => 'Split Knowledgebase To Tabs',
  'RST_DASHBOARD_SPLIT_KB_TO_TABS_DESC' => 'Enable this option if you want the Knowledgebase Categories to be split into tabs.',
  'RST_DASHBOARD_KB_TOP_CATEGORY' => 'Top Knowledgebase Category',
  'RST_DASHBOARD_KB_TOP_CATEGORY_DESC' => 'Choose the Knowledgebase Category you would like to be the top category for the tabs display.',
  ...
  'RST_KB_CATEGORY_ALIAS' => 'Alias',
  'RST_KB_CATEGORY_ALIAS_DESC' => 'The Alias will be used as part of the URL.',
  'RST_KB_ARTICLE_ALIAS' => 'Alias',
  'RST_KB_ARTICLE_ALIAS_DESC' => 'The Alias will be used as part of the URL.',
  'RST_KB_CATEGORY_UNIQUE_ALIAS' => 'Another category with the same parent category has the same alias.',
  'RST_KB_ARTICLE_UNIQUE_ALIAS' => 'Another article in this category has the same alias.',
  ...
  'RST_SHOW_CATEGORY_DESCRIPTION' => 'Show Description',
  'RST_SHOW_CATEGORY_DESCRIPTION_DESC' => 'Enable to show the description of each category in frontend.',
  'RST_SHOW_SUBCATEGORIES_LIST' => 'Show Subcategories',
  'RST_SHOW_SUBCATEGORIES_LIST_DESC' => 'Choose the maximum number of subcategories to display for each category.',
  'RST_KB_SPLIT_CATEGORIES_TO_TABS' => 'Split Categories To Tabs',
  'RST_KB_SPLIT_CATEGORIES_TO_TABS_DESC' => 'Enable this option if you want the Knowledgebase Categories to be split into tabs.',
  'RST_KB_TOP_CATEGORY' => 'Top Category',
  'RST_KB_TOP_CATEGORY_DESC' => 'Choose the category you would like to be the top category for the tabs display.',
  'RST_SHOW_FILTER' => 'Show Filter',
  'RST_SHOW_FILTER_DESC' => 'Shows a textbox that will allow users to search through the articles of the current category.',
  'RST_SHOW_TAG_SORTING' => 'Show Tag Sorting',
  'RST_SHOW_TAG_SORTING_DESC' => 'Enable to display a list of tags corresponding to the articles of the current category.<br>This option will be applied to all categories of the Knowledgebase.',
  'RST_SHOW_TABLE_HEADINGS' => 'Show Table Headings',
  'RST_SHOW_TABLE_HEADINGS_DESC' => 'Set whether you want to display the table headings or not.',
  'RST_SHOW_TABLE_NUMBERING' => 'Show Table Numbering',
  'RST_SHOW_TABLE_NUMBERING_DESC' => 'Enable to show table numbering.',

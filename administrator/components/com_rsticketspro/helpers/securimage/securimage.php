...
class JSecurImage {
	...
	*/
	...
	function JSecurImage()
	{
		...
		$this->wordlist_file = JPATH_ADMINISTRATOR.'/components/com_rsticketspro/helpers/securimage/words/words.txt';
		$this->use_wordlist  = false;

		$this->gd_font_file  = JPATH_ADMINISTRATOR.'/components/com_rsticketspro/helpers/securimage/gdfonts/automatic.gdf';
		$this->use_gd_font   = false;
		$this->gd_font_size  = 24;
		$this->text_x_start  = 15;

		$this->ttf_file      = JPATH_ADMINISTRATOR.'/components/com_rsticketspro/helpers/securimage/AHGBold.ttf';
		...
		$this->signature_font  = JPATH_ADMINISTRATOR.'/components/com_rsticketspro/helpers/securimage/AHGBold.ttf';

		$this->audio_path   = JPATH_ADMINISTRATOR.'/components/com_rsticketspro/helpers/securimage/audio/';

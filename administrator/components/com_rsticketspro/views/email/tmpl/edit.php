...
<form action="<?php echo Route::_('index.php?option=com_rsticketspro&view=email&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate form-horizontal">
	<?php
	...
	<div class="alert alert-info">
		...
		switch ($this->item->type)
		{
			...
			case 'reject_email':
				$placeholders = array('{live_site}', '{customer_name}', '{customer_email}', '{department}', '{subject}', '{reason}');
				break;

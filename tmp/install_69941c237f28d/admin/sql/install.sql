...
CREATE TABLE IF NOT EXISTS `#__rsticketspro_departments` (
  ...
  `email_address_reply_to` varchar(255) NOT NULL DEFAULT '',
  `email_address_reply_to_name` varchar(255) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `#__rsticketspro_kb_content` (
  ...
  `positive_feedback` int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `#__rsticketspro_kb_content_tags` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `#__rsticketspro_kb_content_feedbacks` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `article_id` int(11) NOT NULL,
...
('global_message', ''),
('global_message_position', 'top'),
('submit_message', ''),
('submit_message_position', 'top'),
...
('kb_auto_calculate_hot_hits', '0'),
('kb_auto_calculate_hot_hits_cron_lastcheck', '0'),
('kb_hot_hits', '200'),
...
('en-GB', 'reject_email', 'Re: {subject}', '<p>Hello {customer_name},</p><p>Unfortunately your email for department {department} could not be processed. The reason is specified below:</p><hr /><p><strong>{reason}</strong></p><p>We are sorry for the inconvenience. You can visit <a href="{live_site}">our website</a> instead.</p>'),
